...
import pages.*;
import utils.BaseClassBeforeAndAfterClass;
import utils.DataProviders;
import utils.NavigationHelper;
import utils.ShareData;

public class LumaEndToEndTestWIthOutLogIn extends BaseClassBeforeAndAfterClass {

    @Test(priority = 10, dataProvider = "informationForTwoProducts", dataProviderClass = DataProviders.class)
    ...
    @Test(priority = 20, dependsOnMethods = "addAndCheckoutProductInShoppingCartByClickingItems", dataProvider = "informationForShippingAddress", dataProviderClass = DataProviders.class)
    ...
    @Test(priority = 30, dependsOnMethods = "checkoutPage", dataProvider = "informationForTwoProducts", dataProviderClass = DataProviders.class)
